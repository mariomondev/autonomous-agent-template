...
- `src/cli.ts` - CLI tool for all database operations (status updates, notes, stats, feature listing)
...
4. Inner agent implements features, updates status via `src/cli.ts`
